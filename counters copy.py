...
def read_counters():
    ...
    try:
        ...
        counters = {"client_counter": 0, "quotation_counter": 0, "organization_counter": 0, 'employee_counter': 0, "transaction_counter": 0}
    return counters
...
def transaction_id():
    trans_id = generate_id("TRS", "transaction_counter")
    return str(trans_id)
